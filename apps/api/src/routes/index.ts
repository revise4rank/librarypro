...
import {
  ...
  createStudentBookController,
  updateStudentBookController,
  deleteStudentBookController,
  listPlannerWeekController,
  listPlannerMonthController,
  createPlannerEntryController,
  updatePlannerEntryController,
  deletePlannerEntryController,
  getStudentReferralCodeController,
  getOwnerReferralStatsController,
...
import {
  ...
  deleteOwnerRoomController,
  manualCheckinOwnerController,
  listOwnerPlanTemplatesController,
  createOwnerPlanTemplateController,
  updateOwnerPlanTemplateController,
...
router.get("/owner/plan-templates", requireRole(["LIBRARY_OWNER"]), asyncHandler(listOwnerPlanTemplatesController));
router.post("/owner/plan-templates", requireRole(["LIBRARY_OWNER"]), asyncHandler(createOwnerPlanTemplateController));
router.patch("/owner/plan-templates/:planId", requireRole(["LIBRARY_OWNER"]), asyncHandler(updateOwnerPlanTemplateController));
...
router.post("/owner/checkins/manual", requireRole(["LIBRARY_OWNER"]), requireOwnerPermission("checkins"), asyncHandler(manualCheckinOwnerController));
...
router.delete("/owner/rooms/:roomId", requireRole(["LIBRARY_OWNER"]), requireOwnerPermission("seat_control"), asyncHandler(deleteOwnerRoomController));
...
router.get("/student/referral", requireRole(["STUDENT"]), asyncHandler(getStudentReferralCodeController));
router.get("/owner/referrals", requireRole(["LIBRARY_OWNER"]), asyncHandler(getOwnerReferralStatsController));
router.get("/student/planner/week", requireRole(["STUDENT"]), asyncHandler(listPlannerWeekController));
router.get("/student/planner/month", requireRole(["STUDENT"]), asyncHandler(listPlannerMonthController));
router.post("/student/planner", requireRole(["STUDENT"]), asyncHandler(createPlannerEntryController));
router.patch("/student/planner/:entryId", requireRole(["STUDENT"]), asyncHandler(updatePlannerEntryController));
router.delete("/student/planner/:entryId", requireRole(["STUDENT"]), asyncHandler(deletePlannerEntryController));
router.get("/student/books", requireRole(["STUDENT"]), asyncHandler(listStudentBooksController));
router.post("/student/books", requireRole(["STUDENT"]), asyncHandler(createStudentBookController));
router.patch("/student/books/:bookId", requireRole(["STUDENT"]), asyncHandler(updateStudentBookController));
router.delete("/student/books/:bookId", requireRole(["STUDENT"]), asyncHandler(deleteStudentBookController));
