...
router.get("/admin/dashboard", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("TENANTS"), asyncHandler(getAdminDashboardController));
router.get("/admin/data-overview", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("SETTINGS"), asyncHandler(getAdminDataOverviewController));
router.get("/admin/libraries", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("TENANTS"), asyncHandler(listAdminLibrariesController));
router.get("/admin/libraries/:libraryId/overview", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("TENANTS"), asyncHandler(getAdminLibraryOverviewController));
router.get("/admin/libraries/:libraryId/users", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("USERS"), asyncHandler(listAdminLibraryUsersController));
router.get("/admin/libraries/:libraryId/students", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("USERS"), asyncHandler(listAdminLibraryStudentsController));
router.get("/admin/libraries/:libraryId/payments", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("PAYMENTS"), asyncHandler(listAdminLibraryPaymentsController));
router.get("/admin/libraries/:libraryId/activity", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("OPS"), asyncHandler(listAdminLibraryActivityController));
router.patch("/admin/libraries/:libraryId", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("TENANTS"), asyncHandler(updateAdminLibraryController));
router.patch("/admin/libraries/:libraryId/status", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("OPS"), asyncHandler(updateAdminLibraryStatusController));
router.post("/admin/libraries/:libraryId/archive", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("OPS"), asyncHandler(archiveAdminLibraryController));
router.get("/admin/platform-admins", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("ACCESS"), asyncHandler(listPlatformAdminsController));
router.post("/admin/platform-admins", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("ACCESS"), asyncHandler(createPlatformAdminController));
router.patch("/admin/platform-admins/:userId", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("ACCESS"), asyncHandler(updatePlatformAdminController));
router.get("/admin/plans", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("PLANS"), asyncHandler(listAdminPlanSummariesController));
...
router.get("/admin/marketplace-settings", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("CONTENT"), asyncHandler(getAdminMarketplaceSettingsController));
router.patch("/admin/marketplace-settings", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("CONTENT"), asyncHandler(updateAdminMarketplaceSettingsController));
router.get("/admin/integration-settings", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("SETTINGS"), asyncHandler(getAdminIntegrationSettingsController));
router.patch("/admin/integration-settings", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("SETTINGS"), asyncHandler(updateAdminIntegrationSettingsController));
router.get("/admin/offers", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("CONTENT"), asyncHandler(listAdminOffersController));
router.post("/admin/offers", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("CONTENT"), asyncHandler(createAdminOfferController));
router.get("/admin/review-reports", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("CONTENT"), asyncHandler(listAdminReviewReportsController));
router.get("/admin/syllabus/templates", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("CONTENT"), asyncHandler(listAdminSyllabusTemplatesController));
router.get("/admin/syllabus/template.xlsx", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("CONTENT"), asyncHandler(downloadAdminSyllabusTemplateController));
router.post("/admin/syllabus/import", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("CONTENT"), asyncHandler(importAdminSyllabusTemplatesController));
router.post("/admin/syllabus/import-file", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("CONTENT"), syllabusTemplateUpload.single("file"), asyncHandler(uploadAdminSyllabusTemplatesController));
router.patch("/admin/reviews/:reviewId/moderate", requireRole(["SUPER_ADMIN"]), requirePlatformPermission("CONTENT"), asyncHandler(moderateLibraryReviewController));
router.post(
