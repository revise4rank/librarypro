...
const envSchema = z.object({
  ...
  apiRateLimitMax: z.coerce.number().int().positive().default(1_000),
  publicReadRateLimitMax: z.coerce.number().int().positive().default(2_000),
...
export const env = envSchema.parse({
  ...
  apiRateLimitMax: process.env.API_RATE_LIMIT_MAX ?? 1_000,
  publicReadRateLimitMax: process.env.PUBLIC_READ_RATE_LIMIT_MAX ?? 2_000,
