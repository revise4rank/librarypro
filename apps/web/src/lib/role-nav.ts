export const ownerNav = [
  ...
  { href: "/owner/seats", label: "Seatmap", shortLabel: "SEA" },
  { href: "/owner/checkins", label: "Attendance", shortLabel: "ATT" },
  { href: "/owner/payments", label: "Revenue", shortLabel: "REV" },
...
export const studentNav = [
  { href: "/student/dashboard", label: "Home", shortLabel: "HOM" },
  ...
  { href: "/student/focus", label: "Focus", shortLabel: "FCS" },
