    ...
    <DashboardShell
      ...
      actions={
        <StudentWorkspaceActions>
          <Link href="/student/qr" className="rounded-full border border-[var(--lp-accent-soft)] bg-[var(--lp-accent-soft)] px-5 py-3 text-sm font-bold text-[var(--lp-accent-strong)]">
            Show QR
          </Link>
