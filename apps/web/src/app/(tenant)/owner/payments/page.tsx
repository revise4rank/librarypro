...
export default function OwnerPaymentsPage() {
  return (
    <DashboardShell
      ...
      actions={
        <>
          <Link href="/owner/reports" className="rounded-lg border border-[var(--lp-border)] bg-[var(--lp-surface)] px-4 py-2.5 text-sm font-bold text-[var(--lp-primary)]">
            Open reports
          </Link>
          <Link href="/owner/notifications" className="rounded-lg bg-[var(--lp-accent-soft)] px-4 py-2.5 text-sm font-bold text-[var(--lp-accent)]">
            Due reminders
          </Link>
        </>
      }
