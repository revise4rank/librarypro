...
export function OwnerPaymentsManager() {
  ...
  return (
    <div className="grid gap-3 md:gap-6 xl:grid-cols-[0.82fr_1.18fr]">
      {toast ? (
      ...
      <DashboardCard title="Collections desk" subtitle={`Socket ${liveStatus} | keep entry form hidden until needed`}>
        <div className="grid gap-4">
          <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-1 2xl:grid-cols-2">
            ...
            <div className="grid grid-cols-3 gap-3 rounded-[1.2rem] border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 text-center">
              <div>
        ...
        <form className="grid gap-4" onSubmit={onSubmit}>
          ...
          <input value={form.studentName} onChange={(e) => setForm((c) => ({ ...c, studentName: e.target.value }))} className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none" placeholder="Student name" />
          <div className="grid gap-4 md:grid-cols-2">
            <input value={form.amount} onChange={(e) => setForm((c) => ({ ...c, amount: e.target.value }))} className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none" placeholder="Amount" />
            <select value={form.method} onChange={(e) => setForm((c) => ({ ...c, method: e.target.value }))} className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none">
              <option>Cash</option>
              <option>UPI</option>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <input value={form.referenceNo} onChange={(e) => setForm((c) => ({ ...c, referenceNo: e.target.value }))} className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none" placeholder="Reference number" />
            <select value={form.status} onChange={(e) => setForm((c) => ({ ...c, status: e.target.value }))} className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <input type="date" value={form.paidAt} onChange={(e) => setForm((c) => ({ ...c, paidAt: e.target.value }))} className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none" />
            <input type="date" value={form.dueDate} onChange={(e) => setForm((c) => ({ ...c, dueDate: e.target.value }))} className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none" />
          </div>
