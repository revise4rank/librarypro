  ...
  return (
    <div className="grid gap-6">
      ...
      <section className="grid gap-6 xl:grid-cols-[0.92fr_1.08fr]">
        <DashboardCard title="Create subject" subtitle="Organize your prep by subject and color">
        ...
        <DashboardCard title="Create topic" subtitle="Break subjects into concrete, finishable blocks">
          <div className="grid gap-4">
