    ...
    <div className="grid gap-3 md:gap-6">
      ...
      <section className="grid gap-4 md:grid-cols-4">
        <div className="rounded-[1.75rem] border border-slate-200 bg-white p-5">
          ...
          <p className="mt-3 text-2xl md:text-3xl font-black text-slate-950">{data.analytics.totalSubjects}</p>
        </div>
        <div className="rounded-[1.75rem] border border-slate-200 bg-white p-5">
          <p className="text-xs font-black uppercase tracking-[0.24em] text-slate-400">Topics</p>
          <p className="mt-3 text-2xl md:text-3xl font-black text-slate-950">{data.analytics.totalTopics}</p>
        </div>
        <div className="rounded-[1.75rem] border border-slate-200 bg-white p-5">
          <p className="text-xs font-black uppercase tracking-[0.24em] text-slate-400">Completed</p>
          <p className="mt-3 text-2xl md:text-3xl font-black text-slate-950">{data.analytics.completedTopics}</p>
        </div>
        <div className="rounded-[1.75rem] border border-slate-200 bg-white p-5">
          <p className="text-xs font-black uppercase tracking-[0.24em] text-slate-400">Today</p>
          <p className="mt-3 text-2xl md:text-3xl font-black text-slate-950">{data.analytics.dailyCompletedTopics}</p>
        </div>
      </section>

      <section className="grid gap-3 md:gap-6 xl:grid-cols-[0.92fr_1.08fr]">
