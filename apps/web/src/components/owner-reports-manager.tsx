...
export function OwnerReportsManager() {
  ...
  return (
    <div className="grid gap-3 md:gap-6">
      ...
      <section className="grid gap-4 md:grid-cols-2 2xl:grid-cols-4">
        {insightCards.map((card) => (
          <div key={card.label} className="rounded-[1.75rem] border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-2xl md:text-3xl font-black text-slate-950">{card.value}</p>
      ...
      <section className="grid gap-3 md:gap-6 xl:grid-cols-[1.15fr_0.85fr]">
      ...
      <section className="grid gap-3 md:gap-6">
              ...
              <div className="space-y-3">
                {previewTab === "students"
                  ? reports.students.slice(0, 8).map((row) => (
                      <div key={row.assignment_id} className="flex flex-col gap-3 rounded-[1.25rem] border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                ...
                {previewTab === "payments"
                  ? reports.payments.slice(0, 8).map((row) => (
                      <div key={row.id} className="flex flex-col gap-3 rounded-[1.25rem] border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                          <p className="font-bold text-slate-950">{row.student_name}</p>
                ...
                {previewTab === "expenses"
                  ? reports.expenses.slice(0, 8).map((row) => (
                      <div key={row.id} className="rounded-[1.25rem] border border-rose-200 bg-rose-50 px-3 py-2.5 md:px-4 md:py-4">
                ...
                {previewTab === "attendance"
                  ? reports.checkins.slice(0, 8).map((row) => (
                      <div key={row.id} className="rounded-[1.25rem] border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4">
                        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                          <div>
                            <p className="font-bold text-slate-950">{row.student_name}</p>
