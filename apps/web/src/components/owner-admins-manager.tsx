        ...
        <div className="grid gap-3 md:gap-6">
          <div className="grid gap-3">
            {(admins?.admins ?? []).map((admin) => (
              <div key={admin.user_id} className="rounded-2xl border border-[var(--lp-border)] bg-white px-3 py-2.5 md:px-4 md:py-4">
          ...
          <div className="grid gap-3">
            {logs.slice(0, 12).map((log) => (
              <div key={log.id} className="rounded-2xl border border-[var(--lp-border)] bg-white px-3 py-2.5 md:px-4 md:py-4 text-sm">
