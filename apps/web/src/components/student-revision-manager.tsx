    ...
    <div className="grid gap-3 md:gap-6">
      ...
      <section className="grid gap-4 md:grid-cols-2 2xl:grid-cols-4">
        <div className="rounded-[1.75rem] border border-amber-200 bg-amber-50 p-5">
          ...
          <p className="mt-3 text-2xl md:text-3xl font-black text-slate-950">{revision.analytics.pendingCount}</p>
        </div>
        <div className="rounded-[1.75rem] border border-rose-200 bg-rose-50 p-5">
          ...
          <p className="mt-3 text-2xl md:text-3xl font-black text-slate-950">{revision.analytics.overdueCount}</p>
        </div>
        <div className="rounded-[1.75rem] border border-emerald-200 bg-emerald-50 p-5">
          ...
          <p className="mt-3 text-2xl md:text-3xl font-black text-slate-950">{revision.analytics.completedCount}</p>
        </div>
        <div className="rounded-[1.75rem] border border-slate-200 bg-white p-5">
          <p className="text-xs font-black uppercase tracking-[0.24em] text-slate-400">Consistency</p>
          <p className="mt-3 text-2xl md:text-3xl font-black text-slate-950">{revision.analytics.revisionConsistencyDays} days</p>
        </div>
      </section>

      <section className="grid gap-3 md:gap-6 xl:grid-cols-[0.9fr_1.1fr]">
      ...
      <section className="grid gap-3 md:gap-6 xl:grid-cols-3">
        {[
