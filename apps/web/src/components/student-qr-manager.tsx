...
export function StudentQrManager() {
  ...
  return (
    <div className="grid gap-3 md:gap-6 xl:grid-cols-[1.02fr_0.98fr]">
      <DashboardCard title="Scan library QR" subtitle="Student app camera se library ka QR scan karo">
        <div className="grid gap-5">
          ...
          <div className="rounded-[1.4rem] bg-slate-100 px-3 py-2.5 md:px-4 md:py-4 text-sm font-semibold text-slate-700">
            {scannerStatus}
          </div>
      ...
      <DashboardCard title="Library access status" subtitle="Current active assignment aur scan state">
        <div className="grid gap-4">
          ...
          {message ? <div className="rounded-[1.4rem] bg-emerald-50 px-3 py-2.5 md:px-4 md:py-4 text-sm font-semibold text-emerald-700">{message}</div> : null}
          {error ? <div className="rounded-[1.4rem] bg-rose-50 px-3 py-2.5 md:px-4 md:py-4 text-sm font-semibold text-rose-600">{error}</div> : null}
          ...
          <button
            type="button"
            onClick={() => void loadQr()}
            className="rounded-[1.25rem] border border-[var(--lp-border)] bg-white px-3 py-2.5 md:px-4 md:py-4 text-sm font-bold text-[var(--lp-text)]"
          >
