      ...
      <section
        ...
        style={{
          backgroundImage: profile.hero_banner_url
            ? `linear-gradient(rgba(255,241,227,0.45), rgba(255,248,239,0.50), rgba(229,242,239,0.55)), url(${heroBannerUrl})`
              ...
              <div className="mt-6 grid gap-4">
                ...
                <div className="rounded-[1.5rem] bg-[#f5faf6] p-5">
                  ...
                  {profile.contact_phone ? (
                    <a href={`tel:${profile.contact_phone}`} className="mt-2 block text-lg font-black text-[var(--lp-primary)] underline-offset-2 hover:underline">
                      {profile.contact_phone}
                    </a>
                  ) : (
                    <p className="mt-2 text-lg font-black">Contact available on request</p>
                  )}
                  {profile.whatsapp_phone ? (
                    <a
                      ...
                      className="mt-2 inline-flex items-center gap-2 rounded-full bg-[#25d366] px-4 py-2 text-sm font-bold text-white"
                    >
                      WhatsApp
                    </a>
                  ) : null}
                ...
                <div className="rounded-[1.5rem] bg-[#f5faf6] p-5">
                  ...
                  {profile.email ? (
                    <a href={`mailto:${profile.email}`} className="mt-2 block text-lg font-black text-[var(--lp-primary)] underline-offset-2 hover:underline">
                      {profile.email}
                    </a>
                  ) : (
                    <p className="mt-2 text-lg font-black">Email not published</p>
                  )}
                </div>
                <div className="rounded-[1.5rem] bg-[#f5faf6] p-5">
                  <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[var(--lp-accent)]">Address</p>
