    ...
    <div className="grid gap-3 md:gap-6">
      ...
      <section className="grid gap-4 md:grid-cols-4">
        <div className="rounded-[1.75rem] border border-slate-200 bg-white p-5">
          ...
          <p className="mt-3 text-2xl md:text-3xl font-black text-slate-950">{data.totals.todayMinutes} min</p>
        </div>
        <div className="rounded-[1.75rem] border border-slate-200 bg-white p-5">
          <p className="text-xs font-black uppercase tracking-[0.24em] text-slate-400">This week</p>
          <p className="mt-3 text-2xl md:text-3xl font-black text-slate-950">{data.totals.weeklyMinutes} min</p>
        </div>
        <div className="rounded-[1.75rem] border border-slate-200 bg-white p-5">
          <p className="text-xs font-black uppercase tracking-[0.24em] text-slate-400">Deep work</p>
          <p className="mt-3 text-2xl md:text-3xl font-black text-slate-950">{analytics.deepWorkHours} hrs</p>
        </div>
        <div className="rounded-[1.75rem] border border-slate-200 bg-white p-5">
          <p className="text-xs font-black uppercase tracking-[0.24em] text-slate-400">Streak</p>
          <p className="mt-3 text-2xl md:text-3xl font-black text-slate-950">{analytics.longestStreak} days</p>
        </div>
      </section>

      <section className="grid gap-3 md:gap-6 xl:grid-cols-[1.02fr_0.98fr]">
        <DashboardCard title="Log a study session" subtitle="Fastest action first. Rest can stay tucked away.">
          <div className="grid gap-4">
            <div className="grid gap-4 md:grid-cols-2">
              <select value={sessionForm.subjectId} onChange={(event) => setSessionForm((current) => ({ ...current, subjectId: event.target.value }))} className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none">
              ...
              <select value={sessionForm.sessionType} onChange={(event) => setSessionForm((current) => ({ ...current, sessionType: event.target.value }))} className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <input value={sessionForm.topicTitle} onChange={(event) => setSessionForm((current) => ({ ...current, topicTitle: event.target.value }))} className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none" placeholder="Topic title" />
              <input value={sessionForm.durationMinutes} onChange={(event) => setSessionForm((current) => ({ ...current, durationMinutes: event.target.value }))} className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none" placeholder="Minutes" type="number" min="5" />
            </div>
        ...
        <div className="grid gap-4">
          ...
          {expanded.goals ? (
            <div className="grid gap-4 md:grid-cols-[1fr_1fr_auto]">
              <input value={goalForm.dailyTargetMinutes} onChange={(event) => setGoalForm((current) => ({ ...current, dailyTargetMinutes: event.target.value }))} className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none" placeholder="Daily target minutes" type="number" min="30" />
              <input value={goalForm.weeklyTargetHours} onChange={(event) => setGoalForm((current) => ({ ...current, weeklyTargetHours: event.target.value }))} className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none" placeholder="Weekly target hours" type="number" min="1" />
      ...
      <section className="grid gap-3 md:gap-6 xl:grid-cols-[1fr_1fr]">
            ...
            {expanded.subjects ? (
              <>
                <div className="grid gap-4 md:grid-cols-3">
                  <input value={subjectForm.subjectName} onChange={(event) => setSubjectForm((current) => ({ ...current, subjectName: event.target.value }))} className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none" placeholder="Subject" />
                  <input value={subjectForm.topicName} onChange={(event) => setSubjectForm((current) => ({ ...current, topicName: event.target.value }))} className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none" placeholder="Topic" />
                  <input value={subjectForm.targetMinutes} onChange={(event) => setSubjectForm((current) => ({ ...current, targetMinutes: event.target.value }))} className="rounded-2xl border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none" placeholder="Target minutes" type="number" min="15" />
                </div>
