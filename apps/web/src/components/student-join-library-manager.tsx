...
export function StudentJoinLibraryManager() {
  ...
  return (
    <div className="grid gap-3 md:gap-6 xl:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="grid gap-4">
          ...
          {joinMode === "search" ? (
            <div className="grid gap-4">
              ...
              <div className="grid gap-3">
                ...
                {searchQuery.trim().length >= 2 && !searching && searchableResults.length === 0 ? (
                  <div className="rounded-2xl border border-dashed border-[var(--lp-border)] bg-[#fffdfa] px-3 py-2.5 md:px-4 md:py-4 text-sm text-[var(--lp-muted)]">
            ...
            <div className="grid gap-4">
              ...
              {qrPreview ? (
                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 px-3 py-2.5 md:px-4 md:py-4 text-sm">
      ...
      <DashboardCard title="Library timeline and reviews" subtitle="Track active or past libraries, rejoin quickly, and review only the libraries you actually joined.">
        <div className="grid gap-4">
          ...
          {showTimeline ? (
            <div className="grid gap-3">
              {libraries.map((library) => (
                <div key={library.library_id} className="rounded-2xl border border-[var(--lp-border)] bg-white px-3 py-2.5 md:px-4 md:py-4 text-sm">
          ...
          {showRequestHistory ? (
            <div className="grid gap-3">
              {history.map((item) => (
                <div key={item.id} className="rounded-2xl border border-[var(--lp-border)] bg-white px-3 py-2.5 md:px-4 md:py-4 text-sm">
                  <div className="flex items-start justify-between gap-3">
                    <div>
