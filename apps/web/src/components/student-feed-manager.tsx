...
export function StudentFeedManager() {
  ...
  return (
    <div className="grid gap-3 md:gap-6">
      ...
      <section className="grid gap-3 md:gap-6 xl:grid-cols-[0.95fr_1.05fr]">
            ...
            {showComposer ? (
              <>
                ...
                <textarea
                  ...
                  className="min-h-[140px] rounded-[1.5rem] border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4 outline-none"
            ...
            {showPrivacy ? (
              <>
                ...
                {[
                  ...
                  <label key={key} className="flex items-center justify-between rounded-[1.25rem] border border-slate-200 bg-white px-3 py-2.5 md:px-4 md:py-4">
