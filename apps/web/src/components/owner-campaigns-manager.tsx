  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[1fr_0.9fr]">
      ...
      <DashboardCard title="Campaign preview" subtitle="How your marketplace offer and theme direction will feel to students">
        <div className="rounded-xl border border-[var(--lp-border)] p-5" style={{ background: profile.theme_surface ?? "#fff9f0" }}>
          <div className="rounded-xl p-5 text-white" style={{ background: profile.theme_primary ?? "#d2723d" }}>
          ...
          <div className="mt-4 rounded-xl p-4 text-white" style={{ background: profile.theme_accent ?? "#2f8f88" }}>
