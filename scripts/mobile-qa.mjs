...
const pages = [
  ...
  { key: "library_features", path: "/libraries/focus-library/features", auth: "public" },
  { key: "library_gallery", path: "/libraries/focus-library/gallery", auth: "public" },
  { key: "library_pricing", path: "/libraries/focus-library/pricing", auth: "public" },
