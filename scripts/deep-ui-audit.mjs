...
const auditedPages = [
  ...
  { key: "library-subdomain-features", auth: "public", path: "/library-site/features?slug=focuslibrary" },
  { key: "library-subdomain-gallery", auth: "public", path: "/library-site/gallery?slug=focuslibrary" },
