...
const checks = [
  ...
  ["/libraries/focus-library/features", 200],
  ["/libraries/focus-library/gallery", 200],
  ["/libraries/focus-library/pricing", 200],
  ["/libraries/focus-library/contact", 200],
  ["/library-site?slug=focuslibrary", 200],
  ["/library-site/features?slug=focuslibrary", 200],
  ["/library-site/gallery?slug=focuslibrary", 200],
  ["/owner/login", 200],
  ["/owner/register", 200],
  ["/student/access", 200],
